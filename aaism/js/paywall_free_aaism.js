    ...
    function showUpgrade() {
        ...
        modal.innerHTML = `
            <div style="background:var(--card-bg,#fff);border-radius:16px;padding:28px;max-width:380px;width:100%;text-align:center;box-shadow:0 8px 40px rgba(0,0,0,0.3);">
                ...
                <h2 style="margin:0 0 8px;font-size:1.3rem;color:var(--text,#111);">AAISM Exam Simulator Pro</h2>
                <p style="color:#666;font-size:0.9rem;margin:0 0 20px;line-height:1.5;">
                    Unlock all <strong>725 questions</strong> across all 3 domains.<br>
                    Unlimited sessions · PDF reports · No ads.
                </p>
                <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:16px;">
                    <a href="https://apps.apple.com/app/aaism-exam-simulator-pro/id6763530490" target="_blank"
                    ...
                    <span style="display:flex;align-items:center;justify-content:center;gap:8px;background:#eee;color:#aaa;padding:14px;border-radius:10px;font-size:0.9rem;font-weight:600;cursor:not-allowed;">
